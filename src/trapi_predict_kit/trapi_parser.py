    ...
    for edge_qg_id in query_plan.keys():
        ...
        for predict_func in endpoints_list:
            ...
            for prediction_relation in predict_func._trapi_predict['edges']:
                ...
                if any(i in predicate_parents for i in query_plan[edge_qg_id]['predicates']) and any(i in subject_parents for i in query_plan[edge_qg_id]['subject_types']) and any(i in object_parents for i in query_plan[edge_qg_id]['object_types']):
                    ...
                    for id_to_predict in query_plan[edge_id]["ids_to_predict"]:
                        ...
                        for association in prediction_json:
                            ...
                            if "subject_kg_id" in query_plan[edge_id] and "object_kg_id" in query_plan[edge_id] and target_node_id not in query_plan[edge_qg_id]['object_kg_id']:
                                pass
                                ...
                                node_dict[source_node_id] = {
                                    'type': query_plan[edge_qg_id][f'{rel_to_predict}_types']
                                }
                                if label_to_predict:
